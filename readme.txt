...
Tags: booking system, availability calendar, calendar, appointment booking, google calendar, booking calendar, calendar booking, appointments, scheduling, group booking, booking, booking form
...
Online booking and scheduling for WordPress. Book services or classes with a modern and easy appointment booking calendar.

== Description ==

= Online scheduling and booking plugin =

At Start Booking, we believe that a simple online booking experience is critical to any highly converting website. <a href="https://www.startbooking.com/?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription" rel="friend" title="Start Booking">Start Booking</a> is a WordPress booking plugin that is focused on helping individuals and businesses manage customers, book more appointments, and sell their services.

The appointment scheduling plugin seamlessly connects with the Start Booking cloud platform to power your online booking and display your services or classes anywhere on your WordPress site. The plugin has been developed to adopt and inherit your WordPress theme styles, so minimal (if any) updates are needed to give your website a performant and professional looking booking calendar.
...
Learn more about <a href="https://help.startbooking.com/article/36-how-to-setup-stripe-payments-for-online-booking?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription" rel="friend" title="how to setup Stripe payments for online booking">how to setup Stripe payments for online booking</a>.
...
As a developer, you have the option to configure webhooks for your online booking, which makes it incredibly easy to integrate the scheduling plugin with other systems and applications. This feature enables developers to receive real-time notifications as soon as events occur, such as new bookings or cancellations. The webhooks are straightforward to set up and can be customized to meet individual requirements. As a result, developers can create a booking system that caters to their specific needs and integrates smoothly with their existing systems and workflows. You can learn more from the <a href="https://developers.startbooking.com/" rel="friend" title="Online Booking Developer Center">Start Booking developer center</a>.

= Zapier =

Start Booking is seamlessly linked to over 5,000 applications and services through Zapier. These include CRM systems, payment gateways, communication apps, and more. Enhance your Start Booking experience by integrating it with the tools you're already accustomed to, simplifying the management of your bookings within your established workflow.
...
== Online Booking Feature List ==

* <a target="_blank" href="https://www.startbooking.com/features/online-booking?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription">Streamlined Online Booking</a>: Start Booking offers a user-friendly and intuitive booking process, allowing customers to easily schedule appointments and services.

* Calendar Integration: Seamlessly integrate Start Booking with popular calendar platforms, such as Google Calendar, ensuring accurate scheduling and preventing double bookings.

* Multiple Service Offerings: Efficiently manage and offer a wide range of services with different durations, prices, and availability.

* Automated Notifications: Keep customers informed with automated email and SMS notifications for appointment reminders, confirmations, and rescheduling updates.

* Resource Management: Easily allocate and manage resources, such as staff members or rooms, to ensure efficient scheduling and utilization.

* <a target="_blank" href="https://www.startbooking.com/features/online-payments?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription">Payment Integration</a>: Integrate with Stripe payment gateway, enabling secure and hassle-free online payments during the booking process.

* Reporting and Analytics: Gain valuable insights into your business performance with comprehensive reporting and analytics features, allowing you to make data-driven decisions.

* CRM Integration: Connect Start Booking with your CRM system to streamline customer management, capture client information, and enhance personalized customer experiences.

* <a target="_blank" href="https://zapier.com/apps/start-booking/integrations">Zapier Integration</a>: Seamlessly connect Start Booking with over 5,000 applications and services via Zapier, expanding its capabilities and integrating it into your existing workflow.

* Mobile-Friendly: Access Start Booking and manage appointments on the go with a responsive and mobile-friendly interface.

* Customizable Booking Rules: Set specific rules and restrictions for your bookings, such as minimum or maximum lead times, cancellation policies, or booking prerequisites.

* <a target="_blank" href="https://www.startbooking.com/features/integrations?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription">Booking Integrations</a>: Integrate Start Booking with other third-party software, such as communication tools, marketing platforms, or project management systems, to create a seamless workflow.

* Custom Fields: Collect additional information from customers during the booking process, providing a personalized experience for you and your customers.
...
While we strive to provide the best calendar booking plugin, we know sometimes issues happen. During those times we will do everything we can to resolve your issues and problems as quick as possible. You can find us at the Start Booking <a href="https://help.startbooking.com/?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription" rel="friend" title="support center">help center</a>.

== Installation ==

1. Install the Start Booking Calendar Booking plugin either via the WordPress.org plugin repository or by uploading the files to your server. (See instructions on <a href="https://help.startbooking.com/article/14-how-to-setup-booking-for-wordpress?utm_source=wprepo&utm_medium=link&utm_campaign=plugindescription" rel="friend">how to setup booking for WordPress</a>)
...
== Changelog ==
= 3.5.10 Oct 29th 2023 =
- Fixed how provider parameter filters the service list on the booking flow 
= 3.5.9 Aug 22nd 2023 =
- Updated compatibility with WordPress version 6.3
= 3.5.8 May 29th 2023 =
- Updated plugin description
- Added integrations into plugin
= 3.5.7 May 13th 2023 =
- Updated plugin description
= 3.5.6 April 25th 2023 =
- Fixed how locales get set with new account trials
= 3.5.5 April 22nd 2023 =
- Updated strings for translations in the booking flows 
- Added translations for sr_RS, fr_CA, nl_AW, nl_BE, fr_BE, hr, el, es_MX locales
= 3.5.4 April 8th 2023 =
- Updated compatibility with WordPress version 6.2
- Release new version of onboarding
= 3.5.3 March 12th 2023 =
- No plugin changes. Build process update.
= 3.5.2 March 12th 2023 =
- Fix single appointment screen when Zoom enabled
- Update quick links in class block
= 3.5.1 November 19th 2022 =
- Improve single service block and shortcode button styles
- Update phone input package, better support international numbers
- Remove back button on service list when types skipped
= 3.5.0 November 15th 2022 =
- WPCOM integration, subscription, & connection process
- Fix initialization to include authed user
- Fix phone input fallback logic
= 3.4.3 November 6th 2022 =
- Fix displayed date when changing month
- Fix phone input for international format
- Add prompt before clearing appointment when calendar changes
= 3.4.2 August 26th 2022 =
- PHP 8.1 compatibility improvements
= 3.4.1 July 21th 2022 =
- Update Start Booking settings to use site connection
= 3.4.0 July 20th 2022 =
- Add appointment management to wp-admin
- Add Class, Schedule, & Session management to wp-admin
- Onboarding improvements
= 3.3.3 May 29th 2022 =
- Pass customer timezone when registering
- Display class thumbnails when available
= 3.3.2 May 18th 2022 =
- Fix branding colors on single service items
- Fix timeslot background color
- Add timeslot ranges on openings
- Fix missing media attribute on single service block
- Reduce duplicate CSS files
= 3.3.1 May 13th 2022 =
- Fix onboarding step completion issues
- Fix PHP notices when API request fails
- Add timeslot
= 3.3.0 May 6th 2022 =
- Release thumbnail support in plugin for services
- Code improvements
- Fixed user selects not displaying users name
- Don't show return button at the end of flow if no value
= 3.2.19 April 22nd 2022 =
- Implemented ability to change quantity of classes on initial load
= 3.2.18 April 18th 2022 =
- Fixed issue with translations and ability to book in past classes
= 3.2.17 April 17th 2022 =
- Make button branding apply to span inside button to avoid being overwritten by theme
= 3.2.16 April 16th 2022 =
- Tie in application customization & translation
= 3.2.15 April 10th 2022 =
- Implement branding settings
- Update block_categories filter to use block_categories_all
- Remove more than 12 tags in plugin tags
= 3.2.14 December 10th 2021 =
- Fix date select visual on class calendar day mode
